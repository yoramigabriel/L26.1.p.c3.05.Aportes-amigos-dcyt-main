...
import Cl_cAporte from "./Cl_cAporte.js";

export default class Cl_cRegistroAportes {
  private mRegistro: Cl_mRegistroAportes;
  private vRegistro: I_vRegistroAportes;
  private cAporte: Cl_cAporte;

  constructor(
    vistaRegistro: I_vRegistroAportes,
    controladorAporte: Cl_cAporte,
    billetes5Ant: number,
    ...
    this.mRegistro = new Cl_mRegistroAportes(
      billetes5Ant,
      billetes10Ant,
      billetes20Ant
    );
